...
abstract public class Pipe {
    ...
    /**
     * Calls the method to calculate extra Pipe details then returns the
    ...
    /**
     * Conversion of the length from meters to inches then, calculates the
     * Volume of the pipe from the Diameter and Length.
     *
